...
# start the SQL Server 2017 CU7 downloader
$filepath="$folderpath\SQLServer2017-KB4229789-x64.exe"
if (!(Test-Path $filepath)){
write-host "Downloading SQL Server 2017 CU7..." -nonewline
...
write-host "found the SQL Server 2017 CU7 Installer, no need to download it..."
}
# start the SQL Server 2017 CU5 installer
write-host "about to install SQL Server 2017 CU7..." -nonewline
