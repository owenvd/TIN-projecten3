...
**extra user is normaal, dus alles in orde**
...
-----------+------------------------------------------------------------+-----------
 ...
 rainloop  |                                                            | {}
   ```
**Het verschil in rijen is volstrekt normaal**
...
1. Wanneer ik op een Linux VM mijn nameserver aanpas in: /etc/resolv.conf lukt alles mij.
2. Ik krijg bij het opzoeken met https echter een warning (maar ik vermoed dat deze perfect normaal is daarom dat ik het niet als een probleem zie).
3. Inloggen lukt ook perfect.