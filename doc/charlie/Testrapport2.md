...
# TEST RAPPORT 2: WEBSERVER - CHARLIE

| **auteur testplan** | Moreno Robyn |
| ------------------- | -------------- |
| **uitvoerder test** | Owen Van Damme |

## Fouten

- Stap 1.4 een fout.
- Stap 3 een aantal fouten
- In testrapport vermelden dat DNS server ook nodig is om testplan volledig te kunnen uitvoeren
- iets mis met de laatste stap, kan mss aan DNS server liggen, verder beschreven helemaal onderaan het document.
...
2. Controlleer of nginx active and running is
   ...
   Loaded: loaded (/usr/lib/systemd/system/nginx.service; enabled; vendor prese>
    Drop-In: /usr/lib/systemd/system/nginx.service.d
           └─php-fpm.conf
   Active: active (running) since Mon 2020-11-23 10:38:56 UTC; 3min 24s ago
    Process: 15786 ExecReload=/bin/kill -s HUP $MAINPID (code=exited, status=0/SU>
    Process: 15818 ExecStart=/usr/sbin/nginx (code=exited, status=0/SUCCESS)
    Process: 15815 ExecStartPre=/usr/sbin/nginx -t (code=exited, status=0/SUCCESS)
    Process: 15814 ExecStartPre=/usr/bin/rm -f /run/nginx.pid (code=exited, statu>
    Main PID: 15820 (nginx)
    Tasks: 2 (limit: 5025)
   Memory: 2.5M
   CGroup: /system.slice/nginx.service
           ├─15820 nginx: master process /usr/sbin/nginx
           └─15821 nginx: worker process
   ```
**In orde**
...
System => Linux charlie 4.18.0-193.14.2.el8_2.x86_64 #1 SMP Sun Jul 26 03:54:29 UTC 2020 x86_64
Build Date => Oct 27 2020 15:01:52
Build System => Red Hat Enterprise Linux release 8.2 (Ootpa)
Build Provider => Remi's RPM repository <https://rpms.remirepo.net/>
Server API => Command Line Interface
...
request_order => GP => GP
sendmail_from => no value => no value
sendmail_path => /opt/mailhog/mhsendmail => /opt/mailhog/mhsendmail
serialize_precision => -1 => -1
short_open_tag => Off => Off
SMTP => localhost => localhost
smtp_port => 25 => 25
...
Dynamic Library Support => enabled
Path to sendmail => /opt/mailhog/mhsendmail
...
SSH_CONNECTION => 10.0.2.2 63147 10.0.2.15 22
LANG => en_US.UTF-8
TZ => :/etc/localtime
HISTCONTROL => ignoredups
HOSTNAME => charlie
...
Variable => Value
$_SERVER['LS_COLORS'] => rs=0:di=01;34:ln=01;36:mh=00:pi=40;33:so=01;35:do=01;35:bd=40;33;01:cd=40;33;01:or=40;31;01:mi=01;05;37;41:su=37;41:sg=30;43:ca=30;41:tw=30;42:ow=34;42:st=37;44:ex=01;32:*.tar=01;31:*.tgz=01;31:*.arc=01;31:*.arj=01;31:*.taz=01;31:*.lha=01;31:*.lz4=01;31:*.lzh=01;31:*.lzma=01;31:*.tlz=01;31:*.txz=01;31:*.tzo=01;31:*.t7z=01;31:*.zip=01;31:*.z=01;31:*.dz=01;31:*.gz=01;31:*.lrz=01;31:*.lz=01;31:*.lzo=01;31:*.xz=01;31:*.zst=01;31:*.tzst=01;31:*.bz2=01;31:*.bz=01;31:*.tbz=01;31:*.tbz2=01;31:*.tz=01;31:*.deb=01;31:*.rpm=01;31:*.jar=01;31:*.war=01;31:*.ear=01;31:*.sar=01;31:*.rar=01;31:*.alz=01;31:*.ace=01;31:*.zoo=01;31:*.cpio=01;31:*.7z=01;31:*.rz=01;31:*.cab=01;31:*.wim=01;31:*.swm=01;31:*.dwm=01;31:*.esd=01;31:*.jpg=01;35:*.jpeg=01;35:*.mjpg=01;35:*.mjpeg=01;35:*.gif=01;35:*.bmp=01;35:*.pbm=01;35:*.pgm=01;35:*.ppm=01;35:*.tga=01;35:*.xbm=01;35:*.xpm=01;35:*.tif=01;35:*.tiff=01;35:*.png=01;35:*.svg=01;35:*.svgz=01;35:*.mng=01;35:*.pcx=01;35:*.mov=01;35:*.mpg=01;35:*.mpeg=01;35:*.m2v=01;35:*.mkv=01;35:*.webm=01;35:*.ogm=01;35:*.mp4=01;35:*.m4v=01;35:*.mp4v=01;35:*.vob=01;35:*.qt=01;35:*.nuv=01;35:*.wmv=01;35:*.asf=01;35:*.rm=01;35:*.rmvb=01;35:*.flc=01;35:*.avi=01;35:*.fli=01;35:*.flv=01;35:*.gl=01;35:*.dl=01;35:*.xcf=01;35:*.xwd=01;35:*.yuv=01;35:*.cgm=01;35:*.emf=01;35:*.ogv=01;35:*.ogx=01;35:*.aac=01;36:*.au=01;36:*.flac=01;36:*.m4a=01;36:*.mid=01;36:*.midi=01;36:*.mka=01;36:*.mp3=01;36:*.mpc=01;36:*.ogg=01;36:*.ra=01;36:*.wav=01;36:*.oga=01;36:*.opus=01;36:*.spx=01;36:*.xspf=01;36:
$_SERVER['SSH_CONNECTION'] => 10.0.2.2 63147 10.0.2.15 22
$_SERVER['LANG'] => en_US.UTF-8
$_SERVER['TZ'] => :/etc/localtime
$_SERVER['HISTCONTROL'] => ignoredups
$_SERVER['HOSTNAME'] => charlie
...
$_SERVER['PWD'] => /home/vagrant
$_SERVER['HOME'] => /home/vagrant
$_SERVER['SSH_CLIENT'] => 10.0.2.2 63147 22
$_SERVER['SELINUX_LEVEL_REQUESTED'] =>
$_SERVER['PGDATA'] => /var/lib/pgsql/data
$_SERVER['SSH_TTY'] => /dev/pts/0
$_SERVER['MAIL'] => /var/spool/mail/vagrant
...
$_SERVER['PATH_TRANSLATED'] =>
$_SERVER['DOCUMENT_ROOT'] =>
$_SERVER['REQUEST_TIME_FLOAT'] => 1606128234.7525
$_SERVER['REQUEST_TIME'] => 1606128234
$_SERVER['argv'] => Array
(
)
...
**In orde**
   ...
   Active: active (running) since Sun 2020-11-15 17:14:28 UTC; 7s ago
   Process: 37558 ExecStartPre=/usr/libexec/postgresql-check-db-dir postgresql (code=exited, status=0/SUCCESS)
    Main PID: 37561 (postmaster)
    Tasks: 8 (limit: 5046)
   Memory: 16.6M
   CGroup: /system.slice/postgresql.service
           ├─37561 /usr/bin/postmaster -D /var/lib/pgsql/data
           ├─37563 postgres: logger process   
           ├─37565 postgres: checkpointer process   
           ├─37566 postgres: writer process   
           ├─37567 postgres: wal writer process   
           ├─37568 postgres: autovacuum launcher process   
           ├─37569 postgres: stats collector process   
           └─37570 postgres: bgworker: logical replication launcher 
   ```
   ...
   ```
**Hier hebben we niet hetzelfde resultaat**
   ...
   Active: active (running) since Mon 2020-11-23 10:38:57 UTC; 7min ago
 Main PID: 15847 (php-fpm)
   Status: "Processes active: 0, idle: 5, Requests: 0, slow: 0, Traffic: 0req/s>
    Tasks: 6 (limit: 5025)
   Memory: 31.3M
   CGroup: /system.slice/php-fpm.service
           ├─15847 php-fpm: master process (/etc/php-fpm.conf)
           ├─15849 php-fpm: pool www
           ├─15850 php-fpm: pool www
           ├─15851 php-fpm: pool www
           ├─15852 php-fpm: pool www
           └─15853 php-fpm: pool www
   ```
**In orde**
...
Resultaat
   ...
   ```
total 340
   drwxrwxr-x.  4 nginx nginx    116 Nov 23 10:37 .
   drwxr-xr-x.  4 root  root      36 Nov 23 10:38 ..
   -rw-rw-r--.  1 nginx nginx   2910 Nov 23 10:37 composer.json
   -rw-rw-r--.  1 nginx nginx 327600 Nov 23 10:37 composer.lock
   -rw-rw-r--.  1 nginx nginx    357 Nov 23 10:37 .editorconfig
   -rw-rw-r--.  1 nginx nginx   3858 Nov 23 10:37 .gitattributes
   drwxrwxr-x. 48 nginx nginx   4096 Nov 23 10:37 vendor
   drwxrwxr-x.  7 nginx nginx   4096 Nov 23 10:37 web
   ```
   ```
    drwxrwxr-x.  7 nginx nginx 4096 Nov 23 10:37 .
    drwxrwxr-x.  4 nginx nginx  116 Nov 23 10:37 ..
    -rw-rw-r--.  1 nginx nginx  315 Nov 23 10:37 autoload.php
    drwxrwxr-x. 12 nginx nginx 4096 Nov 23 10:37 core
    -rw-rw-r--.  1 nginx nginx 1025 Nov 23 10:37 .csslintrc
    -rw-rw-r--.  1 nginx nginx  151 Nov 23 10:37 .eslintignore
    -rw-rw-r--.  1 nginx nginx   41 Nov 23 10:37 .eslintrc.json
    -rw-rw-r--.  1 nginx nginx 1507 Nov 23 10:37 example.gitignore
    -rw-rw-r--.  1 nginx nginx 7572 Nov 23 10:37 .htaccess
    -rw-rw-r--.  1 nginx nginx 2314 Nov 23 10:37 .ht.router.php
    -rw-rw-r--.  1 nginx nginx  549 Nov 23 10:37 index.php
    -rw-rw-r--.  1 nginx nginx   94 Nov 23 10:37 INSTALL.txt
    drwxrwxr-x.  2 nginx nginx   24 Nov 23 10:37 modules
    drwxrwxr-x.  2 nginx nginx   24 Nov 23 10:37 profiles
    -rw-rw-r--.  1 nginx nginx 5971 Nov 23 10:37 README.txt
    -rw-rw-r--.  1 nginx nginx 1586 Nov 23 10:37 robots.txt
    drwxrwxr-x.  3 nginx nginx  130 Nov 23 10:37 sites
    drwxrwxr-x.  2 nginx nginx   24 Nov 23 10:37 themes
    -rw-rw-r--.  1 nginx nginx  804 Nov 23 10:37 update.php
    -rw-rw-r--.  1 nginx nginx 4566 Nov 23 10:37 web.config
   ```
**In orde**
...
## Stap 3: PostgreSQL Databank controle
 ...
 2. Log in op PSQL account
   ...
   ```
 3. Controleer de bestaande databases
      Commando:
   ...
   could not change directory to "/home/vagrant": Permission denied
    ...
    -----------+----------+----------+-------------+-------------   +-----------------------
     ...
     rainloop  | rainloop | UTF8     | en_US.UTF-8 | en_US.UTF-8 |
...
**komt niet overeen**
 ...
 4. Controleer of de gebruikers zijn aangemaakt
      Commando:
   ...
   postgres=# \du
    ...
    -----------+------------------------------------------------------------    +-----------
     ...
     rainloop  |                                                            | {}
   ```
**Ik heb precies een extra gebruiker**
 ...
 5. Controleer of de drupal database is aangemaakt
   ...
   ```
    ...
    --------+----------------------------------+-------+--------
     ...
     public | key_value_expire                 | table | drupal
   ...
   ```
    postgres=# \c drupal
    You are now connected to database "drupal" as user "postgres".
    drupal=# \dt
                         List of relations
     Schema |               Name               | Type  | Owner
    --------+----------------------------------+-------+--------
...
**Ik vind de website niet als ik www.corona2020.local opzoek. Als ik op het IP adres zoek krijg ik wel een resultaat. Bravo is up and running, wanneer ik inlog op charlie, doe een nslookup op server 192.168.10.195 naar www.corona2020.local krijg ik wel het juiste ip adres terug**
   ...
   Last login: Mon Nov 23 10:42:07 2020 from 10.0.2.2
   [vagrant@charlie ~]$ nslookup
   > server 192.168.10.195
   Default server: 192.168.10.195
   Address: 192.168.10.195#53
   > charlie.corona2020.local
   Server:         192.168.10.195
   Address:        192.168.10.195#53
   
   Name:   charlie.CORONA2020.local
   Address: 192.168.10.196
   > corona2020.local
   Server:         192.168.10.195
   Address:        192.168.10.195#53
   
   *** Can't find corona2020.local: No answer
   > www.corona2020.local
   Server:         192.168.10.195
   Address:        192.168.10.195#53
   
   www.CORONA2020.local    canonical name = charlie.CORONA2020.local.
   Name:   charlie.CORONA2020.local
   Address: 192.168.10.196
